...
§10.3 で Low/Mid/High 3 シナリオの感度分析実施済み。業者の実際のスプレッドが 0.50-0.80% の場合は §10.3 High シナリオ (-1〜-2%/年) を参照のこと。
...
| CFD スプレッド/オーバーナイト金利 | ✅ 反映済み (cfd_leverage_backtest.py、§10.3 で 3 シナリオ感度分析) | cfd_spread=0.20% (Low)〜0.80% (High) |
...
| 5 | ~~画像1の DH Dyn 2x3x [A] OOS Sharpe 0.646 と corrected_strategy_results.csv の 0.672 の差~~ — **解決済み (2026-05-20)**: OOS 期間の切り出し境界 (2021-05-07 vs 2021-05-08) の 1 日差に起因。どちらも許容範囲内。§A-5 参照 | ✅完了 |
