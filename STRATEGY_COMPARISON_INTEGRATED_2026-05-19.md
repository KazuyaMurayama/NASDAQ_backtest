...
> 凡例: IS = in-sample期間 / OOS = out-of-sample期間 / ★ = カレンダー年ベース10年ローリングCAGR / ‡ = OOS期間(2021/5-2026/3)のみSharpe / ▷ = 日次ローリング5年CAGR下位10%パーセンタイル (§3参照)

| # | 戦略 | CAGR_IS | CAGR_OOS | Worst5Y(FULL) | P10_5Y▷ | Worst10Y★ | MaxDD(FULL) | Sharpe_OOS | Trades/yr |
|---|------|---------|----------|---------|---------|----------|-------|------------|-----------|
| 1 | **S2_VZGated** (tv=0.8, k=0.3, gate=0.5) | +32.94% | +27.57% | −4.75% | **+7.32%** | +17.74%★ | −62.4% | 0.769 | 27 |
