...
- **現行ベスト維持: S2+LT2-N750 ◆**
  ...
  - IS-OOS gap +0.18pp（最小・最高汎化性）
  - WFA CI95_lo=25.7%, WFE=1.145（PASS α∩β）
- **B9-Winner ✅⚠ Shortlisted（保留）**
  - CAGR_OOS・Sharpe・2022年防御では N750 を超過
  - MaxDD(-63.3%), Worst10Y(16.1%), P10(8.1%) が同時悪化
  - IS-OOS gap -5.05pp は Gold 2021-2026 強気エクスポージャ偏重の疑い
  - WFE=1.304 > N750の1.145（Gold OOS bias と整合）
