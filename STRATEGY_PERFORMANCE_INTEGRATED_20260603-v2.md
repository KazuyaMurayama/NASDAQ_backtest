# 戦略パフォーマンス統合レポート v3 — DH-T4 (Full) 改善版追加 (2026-06-03)

**作成日**: 2026-06-03（v3：DH Dyn 2x3x [A] 改善版 DH-T4 を §0' / §5 / §6 / §6-2 の 4 箇所に追加）
**最終更新日**: 2026-06-03
**生成者**: Claude (Opus 4.7)
**著者**: 男座員也 (Kazuya Oza)
...
- v2 (本ファイル過去版): §0' 列構成 v6.1 完全一致版（履歴は git log 参照）

---

## 📋 §0 v3 主要変更点（v2 → v3）

### A. **DH Dyn 2x3x [A] 改善版「DH-T4 (Full)」を 4 箇所に追加** ← v3 の主差分
**商品は現状維持** (TQQQ + TMF + WisdomTree 2036)、**タイミング機構のみ NEW CANDIDATE / D5 から移植**:
- `vz=0.65 ゲート` (NEW CANDIDATE / D5 と同一): LT2 シグナル × VZ-regime k_dyn による NASDAQ 露出抑制
- `lmax=5.5 キャップ` (D5 と同一): `compute_L_s2_vz_gated` 動的レバ上限
- `F10 ε=0.015` (NEW CANDIDATE と同一): `build_f10_wn_for_eps` による配分 tilt の deadband

追加位置（いずれも DH Dyn 2x3x [A] の **1 つ手前**）:
1. §0' 9 指標標準表 → 4 行 → **5 行**
2. §5 年次リターン表 (1977-2026 moderate) → 列追加
3. §6 統計サマリ (1974-2026) → 列追加
4. §6-2 OOS 累積比較 → 行追加

### B. **DH-T4 検証サマリ（一次根拠は `g21a〜g21f` CSV 群）**
| 検証 | 結果 |
|---|---|
| 9 指標標準 (gap 縮小) | ✅ IS-OOS gap **+10.46→+6.81pp** (-3.65pp), WFE **0.662→0.920**（汎化大幅改善） |
| WFA 50 窓 | ✅ PASS (CI95_lo=+14.24%, WFE=0.920, p=0.0000) |
| Bootstrap (T4 vs REF, OOS) | ❌ CI95=[-6.33pp, +5.88pp] (OOS 6 年で noise 内識別不可能) |
| Permutation (vz_thr) | ⚠ MARGINAL (実 gap は NULL 下位 7.0%、5% 閾値の外側) |
| 年次寄与 | ⚠ 2021 単年集中 40.4%、OOS 6 年 diff sum **-2.74pp** (T4 はやや劣るが構造的防御性は維持) |

→ **総合: gap 縮小と WFE 改善は明確だが、OOS 絶対値の優位は noise 内**。「過学習抑制バリアント」として併記。Active 昇格は要追加検証 (v8 以降)。

### C. NEW CANDIDATE / F10 / D5 等の既存 7 戦略は v2 から変更なし（§0' 他は値そのまま）

### D. 旧 §A〜D（v2 → v6.1〜v6.3 由来）は §0-prev に格下げ
...
| **🟡 DH-T4 (vz=0.65+lmax=5.5+F10ε)** ★new | +9.44% | +6.81pp ⚠ | +0.671 | **-37.63%** | +9.37% | **+9.80%** | 152 | ✅ LOW<br>(0.9) | +0.142 |
...
太字 = 列最良値 / 🟢 = v6.3 で「条件付き昇格」確定 / 🟡 = v3 で追加した DH 改善版 (採用判断は要追加検証) / ★new = v3 で新規追加 / ⚠⚠ = IS-OOS gap > +5pp (古典 overfit 強警戒) / ⚠ = +5〜+8pp (中度 overfit)
...
| 年 | NEW 🟢 | F10 ε=0.015 ★ | F8 R5 | F7v3+E4 | D5 v0.65/l5.5 | E4 ◆ | **DH-T4 ★new** | DH [A] | NDX 1x B&H |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 
| 2005 | -21.0 | -21.3 | -21.3 | -20.6 | -11.2 | -18.4 | +1.8 | +1.5 | +2.0 |
| 2006 | +42.2 | +42.4 | +42.4 | +40.1 | +31.9 | +32.9 | +24.9 | +22.3 | +6.3 |
| 2007 | +17.8 | +17.0 | +17.1 | +14.3 | +17.9 | +15.4 | +15.2 | +16.4 | +7.8 |
| 2008 | +16.4 | +16.4 | +16.4 | +16.6 | +17.1 | +17.0 | +19.1 | +18.7 | -32.7 |
| 2009 | +46.3 | +48.1 | +48.1 | +44.1 | +38.4 | +37.6 | +29.1 | +23.0 | +32.3 |
| 2010 | +58.3 | +58.7 | +58.7 | +66.3 | +73.1 | +75.3 | +36.7 | +46.4 | +12.3 |
| 2011 | -16.6 | -16.4 | -16.4 | -15.4 | -7.7 | -8.7 | -5.3 | -5.3 | -2.7 |
| 2012 | +15.6 | +19.6 | +19.6 | +21.1 | +16.8 | +23.4 | +12.3 | +17.9 | +11.6 |
| 2013 | +21.8 | +22.4 | +22.4 | +21.4 | +20.7 | +18.7 | +10.5 | +21.2 | +28.3 |
| 2014 | -4.1 | -0.2 | -0.1 | +2.5 | +3.1 | +5.0 | +0.1 | +10.2 | +11.8 |
| 2015 | -30.9 | -30.4 | -30.4 | -30.3 | -26.5 | -30.9 | -14.3 | -17.3 | +4.9 |
| 2016 | -10.3 | -10.4 | -10.4 | -11.3 | -3.2 | -14.1 | +9.8 | +5.9 | +8.1 |
| 2017 | +66.7 | +67.9 | +68.1 | +62.0 | +48.2 | +59.8 | +19.3 | +23.2 | +22.5 |
| 2018 | -11.3 | -11.3 | -11.3 | -12.0 | -6.0 | -12.5 | +0.8 | -2.2 | -4.4 |
| 2019 | +41.4 | +43.0 | +43.0 | +41.1 | +46.5 | +42.4 | +32.8 | +33.9 | +28.6 |
| 2020 | +69.2 | +65.6 | +65.6 | +62.9 | +59.5 | +60.6 | +50.3 | +62.5 | +34.5 |
| **2021 [OOS]** | **+26.2** | **+19.1** | **+19.1** | **+18.0** | **+18.5** | **+18.4** | **+9.8** | **+20.8** | **+19.2** |
| **2022 [OOS]** | **-22.2** | **-22.1** | **-22.1** | **-22.2** | **-22.4** | **-22.3** | **-20.7** | **-24.1** | **-28.0** |
| **2023 [OOS]** | **+80.3** | **+73.7** | **+73.7** | **+73.0** | **+67.5** | **+68.1** | **+35.8** | **+31.0** | **+36.8** |
| **2024 [OOS]** | **+47.5** | **+47.8** | **+47.7** | **+44.6** | **+40.8** | **+37.1** | **+23.2** | **+21.9** | **+25.5** |
| **2025 [OOS]** | **+41.3** | **+33.5** | **+33.5** | **+33.8** | **+38.8** | **+36.4** | **+26.5** | **+30.5** | **+17.0** |
| **2026 [OOS]** | **-12.8** | **-8.7** | **-8.7** | **-7.9** | **-10.9** | **-7.9** | **-6.8** | **-9.5** | **-6.5** |

---

## 📊 §6 統計サマリ (1974-2026、税後・日次取引コスト後 moderate)

| 統計 | NEW 🟢 | F10 ★ | F8 R5 | F7v3+E4 | D5 v0.65/l5.5 | E4 ◆ | **DH-T4 ★new** | DH [A] | NDX 1x B&H |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| **平均 (mean)** | **+26.80%** | +26.55% | +26.55% | +25.99% | +24.50% | +25.72% | +16.95% | +21.19% | +11.25% |
| 中央値 (median) | +21.77% | +19.64% | +19.64% | +21.07% | +18.47% | +18.69% | +16.34% | +21.19% | +12.34% |
| 標準偏差 (std) | +40.74% | +40.64% | +40.64% | +40.13% | +34.39% | +39.67% | +20.26% | +25.61% | +20.61% |
| 最大 (max) | **+124.13%** | +121.54% | +121.50% | +120.15% | +95.25% | +122.77% | +67.18% | +99.00% | +69.74% |
| 最小 (min) | -41.79% | -41.90% | -41.88% | -40.59% | -33.75% | -37.29% | **-20.68%** | -24.12% | -33.26% |
| プラス年数 | 35 | 35 | 35 | 36 | 36 | 36 | 40 | **41** | 39 |
| マイナス年数 | 18 | 18 | 18 | 17 | 17 | 17 | 13 | **12** | 14 |
...
| **DH-T4 (vz=0.65+lmax=5.5+F10ε) ★new** | +9.8% | -20.7% | +35.8% | +23.2% | +26.5% | -6.8% | ×1.72 | 172万円 |
...
### §9-v3 DH-T4 改善版 (v3 追加分)

| ファイル | 役割 |
|---|---|
| [src/g18_daily_trade_cost_wfa.py](src/g18_daily_trade_cost_wfa.py) | `build_dh_nav_with_timing_cost` 新関数追加（既存関数は無変更） |
| [src/g21a_dh_improved_variants.py](src/g21a_dh_improved_variants.py) | DH 改善 4 変種 (T1〜T4) NAV 生成 |
| [g21a_dh_improved_navs.csv](g21a_dh_improved_navs.csv) | 5 戦略 (REF + T1〜T4) 日次 NAV |
| [src/g21b_dh_improved_metrics.py](src/g21b_dh_improved_metrics.py) | 9 指標標準計算 |
| [g21b_dh_improved_9metrics.csv](g21b_dh_improved_9metrics.csv) | 9 指標表 |
| [src/g21c_dh_improved_wfa.py](src/g21c_dh_improved_wfa.py) | WFA 50 窓検証 |
| [g21c_dh_improved_wfa.csv](g21c_dh_improved_wfa.csv) | WFA 結果（CI95_lo, WFE, p） |
| [src/g21d_dh_improved_bootstrap.py](src/g21d_dh_improved_bootstrap.py) | Bootstrap (T4 vs REF, paired block) |
| [g21d_dh_bootstrap_oos_results.csv](g21d_dh_bootstrap_oos_results.csv) | Bootstrap 結果 |
| [src/g21e_dh_improved_permutation.py](src/g21e_dh_improved_permutation.py) | Permutation (vz_thr 100 samples) |
| [g21e_dh_permutation_summary.csv](g21e_dh_permutation_summary.csv) | Permutation サマリ |
| [g21e_dh_permutation_detail.csv](g21e_dh_permutation_detail.csv) | Permutation 詳細 |
| [src/g21f_dh_improved_attribution.py](src/g21f_dh_improved_attribution.py) | 年次寄与分解 |
| [g21f_dh_t4_vs_ref_yearly_attribution.csv](g21f_dh_t4_vs_ref_yearly_attribution.csv) | T4 vs REF 年次差分 |
| [g21f_dh_t4_yearly_returns_aftertax.csv](g21f_dh_t4_yearly_returns_aftertax.csv) | T4 単独年次税後 |
...
| **v3** | **2026-06-03** | **DH Dyn 2x3x [A] 改善版「DH-T4 (vz=0.65+lmax=5.5+F10ε)」を §0'/§5/§6/§6-2 の 4 箇所に追加（DH の 1 つ手前に配置）** |

---

*管理者: 男座員也 (Kazuya Oza)*
*生成: Claude (Opus 4.7) on 2026-06-03 (v3)*
*準拠: EVALUATION_STANDARD.md v1.4, v3.1 §3-A 税モデル, v6.1 日次取引コスト, v6.2 7戦略拡張, v6.3 5検証パッケージ, v3 DH 改善版*
