...
目的: LT4 信号を S2_VZGated の lev シグナルに modeB で適用し、
     N と k_lt の 2D グリッドで最適構成を探索する。
...
出力:
  - b3_s2_lt4_sweep_results.csv  (プロジェクトルート)
  - B3_S2_LT4_SWEEP_2026-05-22.md (プロジェクトルート)
"""
...
REF_LT2_SHARPE   = 0.858   # S2+LT2-N750-k0.5 (B1 実績)
...
def generate_report(results):
    ...
    lines = [
        f'# B3: S2_VZGated + {LT_SIGNAL} Sweep (N × k_lt)',
        '',
        '作成日: 2026-05-22',
        '最終更新日: 2026-05-22',
        '',
    ...
    lines += [
        ...
        '',
        '```',
        f'python -X utf8 src/b3_s2_lt4_sweep.py',
        '```',
        '',
...
def main():
    ...
    print('=' * 70)
    print(f'B3: S2_VZGated + {LT_SIGNAL} Sweep — {total_runs} runs')
    ...
    print()
    print('=' * 110)
    print(f'B3 {LT_SIGNAL} Results ({total_runs} runs) — sorted by Sharpe_OOS desc')
    print('=' * 110)
