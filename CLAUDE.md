...
2. **★★★マークのセッションサマリーを最優先で参照する**（例: `SESSION_SUMMARY_2026-04-04.md`）
3. ★★マークのファイル（`STRATEGY_COMPARISON_CAGR30per_plus.md` 等）で数値を確認する
4. `CLAUDE.md` や `FINAL_RESULTS.md` は概要・旧版として扱い、最新数値の根拠としない
