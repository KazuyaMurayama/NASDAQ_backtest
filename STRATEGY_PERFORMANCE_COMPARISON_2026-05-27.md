# 戦略パフォーマンス比較表 v1.0 — 2026-05-27 実験全結果
...
## 📊 §2 Group A — 既存4候補 9指標比較表（WFA 完了済み）
...
| **F10 ε=0.015 ✅⚠** | +36.8% | +0.93 ★ | -63.1% | +18.6% | +10.3% | -4.31pp |  52 | +0.279 | +1.208 |
| **vz065+lmax5 ✅⚠** | +33.5% | +0.95 ★ | -51.8% | +18.3% | +11.9% | -3.91pp |  27 | +0.248 | +1.272 |
| **F10+lmax5 ✅⚠** | +33.6% | +0.94 ★ | -54.2% | +16.9% | +12.8% | -3.37pp |  52 | +0.256 | +1.278 |

*◎ Sharpe_OOS > +0.770（S2ベースライン超過）/ ★ > +0.885（現行ベスト超過）。進格: CI95_lo > 0 かつ 0.5 ≤ WFE ≤ 2.0。列名 `Worst10Y★` の ★ は最悪10年CAGRの重要指標記号（Sharpe マーカの ◎/★ とは別意味）。*

### Group A 判定サマリー

| Strategy | 過学習リスク | 判定 | 備考 |
|----------|:----------:|:----:|------|
| E4 ◆ | 低 | Active ✅ | G3 PASS (CI95_lo=+26.5%, WFE=+1.131)。gap=-1.81pp 最小群。Trades=27 低コスト。**現行ベスト確定**。 |
| F10 ε=0.015 | 中 | Shortlisted ⚠ | G7 PASS (CI95_lo=+27.9%, WFE=+1.208)。gap=-4.31pp⚠ IS>OOS 乖離大。Trades=52 高コスト懸念。 |
| vz065+lmax5 | 中 | Shortlisted ⚠ | G10 PASS (CI95_lo=+24.8%, WFE=+1.272)。Sharpe=+0.949 最高。MaxDD=-51.8% 最良。gap=-3.91pp⚠ |
| F10+lmax5 | 中 | Shortlisted ⚠ | G8 PASS (CI95_lo=+25.6%, WFE=+1.278)。P10_5Y=+12.8% 最高。Trades=52 高コスト懸念。 |

---

## 🔬 §3 Group B — 2026-05-27 新規実験 9指標比較表

> WFA 列は D5 vz=0.65 系のみ G10 値。その他 `—` は未実施。
> **‡** = 参照行（E4 と同一、比較基準として掲載）

| Strategy | CAGR<br>_OOS | Sharpe<br>_OOS | MaxDD | Worst<br>10Y★<br>CAGR | P10<br>5Y▷<br>CAGR | IS-OOS<br>gap | Trade<br>（回/年） | CI95<br>_lo | WFE |
|:---------|-------------:|---------------:|------:|----------------------:|-------------------:|--------------:|------------------:|-----------:|----:|
| REF-E4 ‡ | +33.5% | +0.89 ★ ‡ | -60.0% ‡ | +18.7% |  +9.8% | -1.81pp |  27 | +0.265 | +1.131 |
| [B4] k_lo=0/k_hi=0.7/vz=0.7 | +33.3% | +0.89 ★ | -60.4% | +18.6% |  +9.9% | -1.62pp |  27 |    —    |    —    |
| [A1] α=8 (Sharpe最大) | +35.1% | +0.90 ★ | -67.1% | +18.2% |  +6.4% | -2.48pp |  27 |    —    |    —    |
| [A1] α=2 (MaxDD改善) | +33.5% | +0.89 ★ | -61.6% | +18.6% |  +7.8% | -1.33pp |  27 |    —    |    —    |
| [A2] lmax_base=6/vol_sens=2 | +32.6% | +0.90 ★ | -58.7% | +18.5% | +10.7% | -1.19pp |  27 |    —    |    —    |
| [A2B] lmax_base=6/vol_sens=2 (rolling VOL_REF) | +31.7% | +0.89 ★ | -56.9% | +18.6% | +11.1% | -0.87pp |  27 |    —    |    —    |
| [A3] VoV+vz dual gate (vov_thr=1.3/α=0.2) | +33.5% | +0.89 ★ | -60.0% | +18.7% |  +9.8% | -1.81pp |  27 |    —    |    —    |
| [C2] adaptive deadband (ε₀=0.020) | +36.8% | +0.93 ★ | -63.0% | +18.6% | +10.3% | -4.28pp |  51 |    —    |    —    |
| [C3] Yang-Zhang vol (yz_n=10/vz=0.7) | +33.3% | +0.89 ★ | -58.4% | +19.4% | +10.6% | -2.05pp |  27 |    —    |    —    |
| [D5] vz=0.65/lmax=5.5 ✅ | +34.6% | +0.94 ★ | -53.4% | +18.8% | +11.5% | -4.14pp |  27 | +0.257 | +1.257 |
| [D5] vz=0.65/lmax=6.0 ✅ | +35.3% | +0.94 ★ | -54.9% | +19.5% | +10.9% | -4.20pp |  27 | +0.263 | +1.244 |
| [D5] vz=0.65/lmax=7.0 ✅⚠ | +37.0% | +0.95 ★ | -58.7% | +18.7% |  +9.2% | -5.22pp |  27 | +0.269 | +1.230 |
| [D5] vz=0.60/lmax=4.5 | +28.9% | +0.88 ◎ | -49.2% | +18.1% | +11.8% | -0.15pp |  27 |    —    |    —    |
...
| **A1** α=8 | soft sigmoid で Sharpe 向上 | WARN | Sharpe=+0.904 向上だが MaxDD=-67.1% 悪化⚠。gap=-2.48pp 拡大。 |
| **A1** α=2 | soft sigmoid で MaxDD 改善 | WARN | MaxDD=-61.7% 改善不十分。Sharpe=+0.886 < E4。効果微小。 |
| **A2** base=6/sens=2 | vol 感応 l_max で MaxDD 改善 | WARN | MaxDD=-58.7% 改善。ただし CAGR=+32.6% 低下。E4 非優越。 |
| **A2B** base=6/sens=2 | 10年ローリング VOL_REF で中立化 | FAIL | vol_ref_t=0.161（mean < 常時閾値）→ l_max 常時削減バイアス。CAGR=+31.7% 大幅低下。 |
| **A3** vov=1.3/α=0.2 | VoV z-score で Volcker 期を回避 | FAIL | MaxDD=-60.01% 変化なし。1980-82 Volcker 期は vol 低下期→ VoV シグナル 0 日発火。構造的限界。 |
| **C2** ε₀=0.020/adaptive | 適応 deadband で IS-OOS gap 縮小 | WARN | F10 と同性能（Sharpe=+0.935, CAGR=+36.84%）。gap=-4.28pp⚠ 改善なし。Trades=51 高コスト。 |
...
| vz065-lmax5 | ✅ PASS | +24.82% | +1.272 | Group A vz065+lmax5 と同一。Sharpe 最高（WFA内）。 |
| vz065-lmax5p5 | ✅ PASS | +25.71% | +1.257 | CAGR=+34.6%, Sharpe=+0.945。CI95_lo 最高。 |
...
| Sharpe_OOS 最高 | vz065+lmax5 (Group A) | +0.949 |
| MaxDD 最良 | D5 vz=0.60/lmax=4.5 | −49.2% |
| Worst10Y★ 最高 | C3 yz_n=10 | +19.37% |
| P10_5Y 最高 | F10+lmax5 (Group A) | +12.8% |
| IS-OOS gap 最小 | D5 vz=0.60/lmax=4.5 | −0.15pp |
| WFA CI95_lo 最高 | F10 ε=0.015 (Group A) | +27.9% |
...
| **A1** soft regime | ❌ 棄却 | MaxDD 悪化 or Sharpe 改善微小。過学習リスク高。 |
...
| **D5** vz=0.65 × lmax | ✅ 確認 | vz_thr=0.65 が Pareto 最適（全 l_max でベスト Sharpe）。vz065+lmax5 採用候補確定。 |

### ◆ 現行ベスト維持 + 採用候補

> **◆ 現行ベスト: E4 Regime k_lt (lo=0.1/hi=0.8/vz=0.7)** — Active 変更なし
>
> **Shortlisted (採用変更候補・ユーザー判断待ち)**:
> 1. **vz065+lmax5**: Sharpe=+0.949（最高）, MaxDD=-51.8%（最良）, Trades=27（低コスト）
>    G10 PASS (CI95_lo=+24.8%, WFE=+1.272)。gap=-3.91pp⚠ が唯一の懸念。
> 2. **F10 ε=0.015**: CAGR=+36.8%（高リターン）。G7 PASS。ただし Trades=52 高コスト・gap=-4.31pp⚠。
> 3. **F10+lmax5**: P10_5Y=+12.8%（最高）, MaxDD改善。G8 PASS。Trades=52 高コスト。
>
> **今回実験から追加検討値**:
> - **D5 vz=0.65/lmax=5.5**: CAGR=+34.6%, Sharpe=+0.945。G10 PASS。次善候補。
> - **C3 Yang-Zhang**: Worst10Y=+19.37%（最高）。WFA 未実施→要 WFA。
...
| ファイル | 実験 | 役割 |
|----------|------|------|
| `b4_klo_zero_results.csv` | B4 | k_lo=0 実験 9指標（E4 REF含む） |
| `a1_soft_regime_klt_results.csv` | A1 | soft sigmoid 実験 9指標 |
...
| `g8_wfa_lmax5_summary.csv` | G8 | F10+lmax5 / E4-lmax5 WFA（G8） |
...
| `EVALUATION_STANDARD.md` | — | 評価基準 v1.1 |
...
| 版 | 日付 | 変更内容 |
|----|------|---------|
| **v1.0** | 2026-05-27 | 初版。2026-05-27 全実験（B4/A1/A2/A2B/A3/C2/C3/D5）の §3.12 準拠 9指標比較表。Group A × 4 + Group B × 13 計 17 戦略。 |
