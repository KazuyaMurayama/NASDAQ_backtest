# 戦略パフォーマンス比較表 v1.7 — 2026-05-27 統合21戦略比較
...
| **[Active候補] F10 ε=0.015 ✅⚠** | +36.8% | +0.93 ★ | -63.1% | +18.6% | +10.3% | -4.31pp |  52 | +0.279 | +1.208 |
| **[Active候補] F10+lmax5 ✅⚠** | +33.6% | +0.94 ★ | -54.2% | +16.9% | +12.8% | -3.37pp |  52 | +0.256 | +1.278 |
| **[Active候補] D5 vz=0.65/lmax=5.0 ✅⚠** | +33.5% | +0.95 ★ | -51.8% | +18.3% | +11.9% | -3.91pp |  27 | +0.248 | +1.272 |
| [B] B4 k_lo=0/k_hi=0.7/vz=0.7 | +33.3% | +0.89 ★ | -60.4% | +18.6% |  +9.9% | -1.62pp |  27 |    —    |    —    |
| [A] A1 α=2 (soft regime) | +33.5% | +0.89 ★ | -61.6% | +18.6% |  +7.8% | -1.33pp |  27 |    —    |    —    |
| [A] A1 α=3 (soft regime) | +33.9% | +0.89 ★ | -62.9% | +18.4% |  +7.4% | -1.59pp |  27 |    —    |    —    |
| [A] A1 α=5 (soft regime) | +34.6% | +0.90 ★ | -65.0% | +18.3% |  +6.9% | -2.06pp |  27 |    —    |    —    |
| [A] A1 α=8 (soft regime) | +35.1% | +0.90 ★ | -67.1% | +18.2% |  +6.4% | -2.48pp |  27 |    —    |    —    |
| [A] A2 lmax_base=6/vol_sens=2 | +32.6% | +0.90 ★ | -58.7% | +18.5% | +10.7% | -1.19pp |  27 |    —    |    —    |
| [A] A2B rolling VOL_REF | +31.7% | +0.89 ★ | -56.9% | +18.6% | +11.1% | -0.87pp |  27 |    —    |    —    |
| [A] A3 VoV dual gate (vov=1.3/α=0.2) | +33.5% | +0.89 ★ | -60.0% | +18.7% |  +9.8% | -1.81pp |  27 |    —    |    —    |
| [C] C2 adaptive deadband (ε₀=0.020) | +36.8% | +0.93 ★ | -63.0% | +18.6% | +10.3% | -4.28pp |  51 |    —    |    —    |
| [C] C3 Yang-Zhang (yz_n=10/vz=0.7) | +33.3% | +0.89 ★ | -58.4% | +19.4% | +10.6% | -2.05pp |  27 |    —    |    —    |
| [D5] vz=0.60/lmax=4.5 | +28.9% | +0.88 ◎ | -49.2% | +18.1% | +11.8% | -0.15pp |  27 |    —    |    —    |
| [D5] vz=0.60/lmax=5.0 | +31.3% | +0.90 ★ | -51.1% | +18.8% | +11.9% | -1.28pp |  27 |    —    |    —    |
| [D5] vz=0.65/lmax=4.5 | +30.9% | +0.93 ★ | -49.9% | +17.7% | +11.8% | -2.46pp |  27 |    —    |    —    |
...
| [D5] vz=0.70/lmax=5.0 | +30.6% | +0.90 ★ | -54.1% | +16.9% | +12.1% | -1.00pp |  27 |    —    |    —    |

*◎ Sharpe_OOS > +0.770（S2ベースライン超過）/ ★ > +0.885（現行ベスト超過）。進格: CI95_lo > 0 かつ 0.5 ≤ WFE ≤ 2.0。列名 `Worst10Y★` の ★ は最悪10年CAGRの重要指標記号（Sharpe マーカの ◎/★ とは別意味）。*

**WFA 完了行**: 7/21（E4 ◆ + Active候補3行 + D5 vz=0.65 系3行）
**WFA 未実施行**: 14/21（B4, A1×4, A2/A2B/A3, C2/C3, D5 vz=0.60/0.70 系4行）
