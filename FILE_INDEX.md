...
> **注意**: このファイルはリポジトリ全体のファイル一覧です。ファイル検索やファイル参照を行う際には、まずこの一覧を参照してください。
...
| `FINAL_RESULTS.md` | 最終戦略比較結果レポート（全戦略の性能一覧） | 全ブランチ |
...
| `REGIME_ANALYSIS_REPORT.md` | レジーム分析レポート（市場環境分類） | compare-trading-strategies-PPCbl |
| `STRATEGY_COMPARISON.md` | 7戦略比較レポート | compare-trading-strategies-PPCbl |
| `STRATEGY_COMPARISON_CAGR30per_plus.md` | CAGR30%超戦略比較 | compare-trading-strategies-PPCbl |
| `YEARLY_RETURNS_REPORT.md` | 年次リターン詳細レポート | compare-trading-strategies-PPCbl |
