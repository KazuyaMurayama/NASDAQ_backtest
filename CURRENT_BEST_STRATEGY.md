...
| CAGR ⓽_OOS（税後・§3-A概算） | **+28.01%**（公式 canonical）/ 単純推計≈+27.2% | 公式⓽: `aftertax_cagr_canonical_20260607.csv` → **+28.01%** (canonical OOS 4.884年, IS_END=2021-05-07, yearly ×0.8273)。単純§3-A推計: (33.53−0.66)×0.8273≈+27.2%（moderate spread未加算）。保守: (30.5−0.66)×0.8273≈+24.6% |
