...
|---|---|---|---|---|---|---|---|
| F8 R5_CALM_BOOST | +0.934 | +36.83%★ | **+30.5%** | −63.07% | 182 | +27.92% | Trades/yr過多、OOS偶然性疑い |
| F7v3+E4 A:tilt=2.0 | +0.926 | +36.30%★ | **+29.8%** | −61.96% | 183 | +27.15% | 同上 |
| LT2-N750 固定k=0.5 | +0.858 | +31.16%★ | — | −59.45% | 27 | +25.7% | E4に劣後、WFA PASS済み |

*★ raw = 税引前・旧スプレッド（Scenario D コスト後、税前）。*
*手取り = 年次リターン ×0.8273 逐年複利（`f8r5_yearly_returns.csv` / `f7v3_yearly_returns.csv` を逐年適用）。MaxDD★は年次近似値で日中ドローダウンを過小評価（after-tax年次近似: F8=-38.1%, F7v3=-36.8%）。*
