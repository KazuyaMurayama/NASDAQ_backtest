...
| **B3a+G5_vix_hard**<br>B3a + vix_mom21 防御<br>オーバーレイ{Q2:0.92,Q3:0.85}<br>（リスク低減オプション）<br>DH_W1+Signal+DefOverlay | 2026-06-15 | realistic TQQQ+k365（⓽=×0.8273） | +22.7%※ / **+20.73%**（**min +20.73%**） | +2.0pp※ | **0.928** | **−35.93%** | +13.74% | +8.26% | 52.9 | ✅ 0.990 | +21.54% | **Shortlisted（B3aのリスク低減オプション・defensiveオーバーレイ）** | B3aに vix_mom21 のdefensiveマップを native重畳。**MaxDD −38.20%→−35.93%（+2.27pp・bootstrap P=0.96/0.88＝有意）・Sharpe +0.024** を min⓽ −0.32pp で獲得。>3x日も37.7→32.8%に低下。B3aの最大弱点（対P09 MaxDD −7.5pp）を約2.3pp埋め戻す。代償は取引33→53/yr。6次元総合は採点器の取引ペナルティで B3a を僅かに下回る(BAL8.13<8.27)が、取引コストはCAGRに既計上で二重計上気味。「MaxDDを有意に縮めSharpeを上げたい」局面の選択肢。成功要素グラフト探索([MULTISTRATEGY_COMBINE_RESULTS_20260615.md])で5要素中唯一の改善レバー。 | [MULTISTRATEGY_COMBINE_RESULTS_20260615.md](MULTISTRATEGY_COMBINE_RESULTS_20260615.md), [src/audit/combine_g5_defoverlay_20260615.py](src/audit/combine_g5_defoverlay_20260615.py), [src/audit/combine_phase2_fullgate_20260615.py](src/audit/combine_phase2_fullgate_20260615.py) |
