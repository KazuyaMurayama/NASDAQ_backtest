...
作成日: 2026-05-21
最終更新日: 2026-05-24 (F8 R5_CALM_BOOST の G5 WFA PASS → 正式 Active 昇格; CI95_lo=+27.92%, WFE=+1.208)
管理者: Kazuya Murayama
...
| Strategy ID | Name | Theme | Verified Date | Cost Scenario | CAGR_OOS | Sharpe_OOS | MaxDD | Status | Decision Reason | Evidence |
|---|---|---|---|---|---|---|---|---|---|---|
| **S2_VZGated+LT2_N750_E4_F8R5** | S2_VZGated + LT2-N750 + E4 Regime k_lt + F8 R5_CALM_BOOST (tilt=10 step-func, cap=calm0.15/bullVZ0.10/bearVZ0.05) | CFDLeverage + LongCycleSignal + VolRegime + RegimeCapBullTilt | 2026-05-24 | D | **+36.83%** | **0.934** | −63.07% | **Active (WFA PASS 確定)** | F8 R5_CALM_BOOST: calm時cap=0.15拡大 / bear-VZ時cap=0.05縮小のレジーム別 cap 設定。Sharpe_OOS +0.934（PASS基準+0.023超過）、CAGR_OOS +36.83%、WFA CI95_lo +27.92%（F7v3+E4比+0.77pp）。5指標で前版 F7v3+E4 (Sharpe +0.926) を上回る。MaxDD −63.07% は guardrail 内（−65.01%）。**G5 WFA PASS (2026-05-24): CI95_lo=+27.92% (α PASS, t_p=0.0000), WFE=+1.208 (β PASS)** → 正式 Active 確定。 | [F8_REGIME_TILT_2026-05-24.md](F8_REGIME_TILT_2026-05-24.md), [f8_regime_tilt_results.csv](f8_regime_tilt_results.csv), [src/f8_regime_tilt.py](src/f8_regime_tilt.py), [G5_WFA_F8R5_2026-05-24.md](G5_WFA_F8R5_2026-05-24.md), [g5_wfa_f8r5_summary.csv](g5_wfa_f8r5_summary.csv), [src/g5_wfa_f8r5.py](src/g5_wfa_f8r5.py), [CURRENT_BEST_STRATEGY.md](CURRENT_BEST_STRATEGY.md) |
...
| Strategy ID | Name | Theme | Verified Date | Cost Scenario | CAGR_OOS | Sharpe_OOS | MaxDD | Status | Decision Reason | Evidence |
|---|---|---|---|---|---|---|---|---|---|---|
| **S2_VZGated+LT2_N750_E4_F7v3** | S2_VZGated + LT2-N750 + E4 Regime k_lt + F7v3 Bull-Tilt (A:tilt=2.0, flat cap=0.10) | CFDLeverage + LongCycleSignal + VolRegime + BullTilt | 2026-05-24 | D | +36.30% | 0.926 | −61.96% | Shortlisted | 旧 Active（〜2026-05-24）。F8-R5 が Sharpe +0.934 / CAGR +36.83% / WFA CI95_lo +27.92% で5指標優位。MaxDD −61.96% は現行 Active より良好。G4 WFA PASS済み（CI95_lo=+27.15%, WFE=+1.203）。MaxDD改善優先時の fallback 第一候補。 | [F7V3_BULL_TILT_2026-05-24.md](F7V3_BULL_TILT_2026-05-24.md), [G4_WFA_F7V3_2026-05-24.md](G4_WFA_F7V3_2026-05-24.md), [g4_wfa_f7v3_summary.csv](g4_wfa_f7v3_summary.csv) |
