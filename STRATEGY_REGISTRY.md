...
| **B3a レバ拡張フロンティア**<br>scale 1.20〜1.35<br>(±強map/early re-entry)<br>＝B3aの高CAGR側ダイヤル | 2026-06-16 | realistic TQQQ+k365（⓽=×0.8273） | 〜+26.8% / 〜**+23.97%**（scale/enterで連続） | +2.8〜3.6pp | 0.88〜0.95 | −40〜−48% | +15〜17% | 〜+9% | 33〜36 | ✅ 0.92〜0.95 | 〜+26.6% | **Shortlisted（CAGR最大化ダイヤル・リスク選好で点を選ぶ）** | B3aの uniform leverage を 1.15超へ拡張すると min⓽ が連続的に上昇（1.25→+22.1% / 1.35→+23.8% / combo e0.60×sc1.25→**+23.97%上端**）。**ベト−50%到達は概算 scale≈1.50**でフロンティアに余地あり。**ただし純レバアップ＝Sharpe非改善・MaxDD比例悪化・min改善は95%非有意（bootstrap CI95_lo負）・worst年−26%**。早期再エントリー(enter0.60)はSharpe0.955と高いがgap圧縮がOOS強気依存。推奨: バランス=B3a維持／やや攻め=scale1.25(MaxDD−40%)／攻め=scale1.35強map(MaxDD−45%・CI95_lo+26.6%)。combo上端はベト間近で非推奨。詳細フロンティア=[LEVERUP_EXTENSION_RESULTS_20260616.md]。 | [LEVERUP_EXTENSION_RESULTS_20260616.md](LEVERUP_EXTENSION_RESULTS_20260616.md), [src/audit/leverext_scale_20260616.py](src/audit/leverext_scale_20260616.py), [src/audit/leverext_reentry_20260616.py](src/audit/leverext_reentry_20260616.py), [src/audit/leverext_combo_20260616.py](src/audit/leverext_combo_20260616.py) |
